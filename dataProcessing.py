...
imagename = sorted(glob.glob(TRAINDATA_DIR+'vehicle/udacity/non-vehicles/Extras/*.png')) #5068
imagename2 = sorted(glob.glob(TRAINDATA_DIR+'vehicle/udacity/non-vehicles/GTI/*.png')) #3900
...
foldername = sorted(glob.glob(TRAINDATA_DIR+'vehicle/udacity/vehicles/*'))
...
dir = TRAINDATA_DIR+ "vehicle/CrowdAI/object-detection-crowdai"
...
import pandas as pd
dir = TRAINDATA_DIR+ 'vehicle/Autti/object-dataset'
